...
**Workspace note:** Manuscript lives under `book/manuscript/`, appendices under `book/appendices/`, project meta (this file, full outline) under `book/meta/`. Deploy `book/` to Quartz content as your pipeline defines. Avoid duplicating editorial work in `kenyan-tech-stack-garden/` to prevent drift.
...
|-------------------|--------------|--------|-------|
| 1) Banking in the Dark: Bespoke Software for Banks & Traders | §1 Banking in the Dark | **Partial** | Narrative present; named characters missing |
| 2) The Cybercafé Republic | §2 The Cybercafe Republic | **Partial** | Narrative present; no cited vignettes or stats |
| 3) Telcoms Before the Boom: The Mobile Explosion | §3 Telcoms Before the Boom | **Partial** | Narrative present; no named telco figures or dates |

### Missing from Structure (Coverage Gaps)

| Structure Element | In Book? | Action |
|-------------------|----------|--------|
| **Kamal Budhabhatti (Craft Silicon)** — anchor character | No | Add section; cite company history, interviews, press |
...
| Telcoms: first SIM era, Safaricom/Telkom split, coverage milestones | No | Add dates and cite CA/telco reports |
...
- [ ] §1: Add footnote for "1988" or enterprise software era — need a source
- [ ] §1: Add Craft Silicon / Kamal Budhabhatti with citation when introduced
- [ ] §2: Add timeline for cybercafé proliferation (e.g., "By 2005, Nairobi had X cybercafés" — cite)
- [ ] §2: Add one concrete vignette (e.g., specific cybercafé story from news or report)
- [ ] §3: Add mobile subscriber milestones (year, numbers) — cite CA or GSMA
- [ ] §3: Add named telco figure or event if structure calls for it
