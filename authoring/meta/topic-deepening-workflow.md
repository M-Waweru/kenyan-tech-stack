...
Collect **at least two independent source types** per major claim where possible:

| Type | Examples |
|------|-----------|
| **Primary / official** | CBK, CA, company newsroom, Kenya Law, annual reports |
| **Industry body** | KBA banking history, association timelines |
| **Trade / quality press** | Nation, Standard, Business Daily, TechCrunch Africa-era |
...
- **Composite characters** (“a branch operations manager”, “a cybercafé attendant on Tom Mboya Street”) are fine for **atmosphere** if you do **not** imply a single real individual. Prefer **documented settings** (night shift, payroll cut-off, café price board).
